...
:: Android packaging
set AND_CERT_NAME="VideoChatMobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\VideoChatMobile.p12
...
set IOS_PROVISION=cert\VideoChatMobile.mobileprovision
...
set APP_ID=air.VideoChatMobile

:: Output packages
set DIST_PATH=dist
set DIST_NAME=VideoChatMobile
