...
package front
{
    ...
    class VideoChat extends Sprite{
        ...
        private function onInit(event:Event = null):void 
        {
			...
			var title:Bitmap = new title2Embed() as Bitmap;
        ...
        private function netStatusHandler(e:NetStatusEvent):void {
            ...
            switch(e.info.code){
                ...
                case "NetGroup.Posting.Notify":
					...
					if (e.info.message.x && e.info.message.y) {
						
						CubeMeshEarthManager.getInstance().move(e.info.message.x, e.info.message.y);
					}
